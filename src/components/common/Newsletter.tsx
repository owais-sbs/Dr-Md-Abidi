    ...
    <section className="bg-ink-50">
      <div className="container-page py-16 sm:py-20">
        ...
        >
          ...
          <motion.form variants={fadeUp} onSubmit={onSubmit} className="mt-8 flex flex-col items-stretch gap-4 max-w-xl mx-auto">
            ...
            <div className="text-left">
              <LegalConsentCheckbox id="newsletter-consent" checked={legalAgreed} onChange={setLegalAgreed} />
            </div>
          </motion.form>
          {submitted && (
            <motion.p
