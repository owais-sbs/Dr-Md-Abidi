...
export const mainNav: NavItem[] = [
  ...
  },
  {
    ...
    href: '/iv-packages/',
    children: [
      { label: 'Power-Up',               href: '/iv-packages/power-up/' },
      { label: 'Immunify',               href: '/iv-packages/immunify/' },
      { label: 'Go With The Flow',       href: '/iv-packages/go-with-the-flow/' },
      { label: 'Fountain Of Youth',      href: '/iv-packages/fountain-of-youth/' },
      { label: 'Myers Cocktail',         href: '/iv-packages/myers-cocktail/' },
      { label: '1,000 cc Saline Hydration', href: '/iv-packages/saline/' },
